...
import com.ma.tehro.common.getWindowHeight
...
fun Lines(
    ...
    val itemHeight = remember(screenHeight, lines.size) {
        ((screenHeight / (lines.size + 1)) * 1.2f)
            .coerceAtLeast(74.dp)
    }
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                item {
                    Spacer(modifier = Modifier.height(itemHeight - (itemHeight / 4)))
                }
            }
        }
